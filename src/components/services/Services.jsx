        ...
        <div className='services_main m-4'>
            <div className='row text-center g-4'>
                <div className='col-6 col-lg col-md-4 m-0 my-4'>
                    <div>
                        <i className='bx bx-rocket bx-flashing-hover bx-lg mb-3' style={{ color: "#FCB800" }} ></i>
                ...
                <div className='col-6 col-lg col-md-4 m-0 my-4'>
                    <div>
                        <i className='bx bx-sync bx-lg mb-3 bx-spin-hover' style={{ color: "#FCB800" }} ></i>
                ...
                <div className='col-6 col-lg col-md-4 m-0 my-4'>
                    <div>
                        <i className='bx bx-credit-card-front bx-burst-hover bx-lg mb-3' style={{ color: "#FCB800" }} ></i>
                ...
                <div className='col-6 col-lg col-md-4 m-0 my-4'>
                    <div>
                        <i className='bx bx-message-rounded-check bx-fade-up-hover bx-lg mb-3' style={{ color: "#FCB800" }}></i>
                ...
                <div className='col-6 col-lg col-md-4 m-0 my-4'>
                    <div>
                        <i className='bx bx-gift bx-lg mb-3 bx-tada-hover' style={{ color: "#FCB800" }}></i>
